...
- `mode`：MBTI 为 `short`、`full`；DND 为 `full`。
...
{
  "测试": [
    {"name": "mbti", "display": "MBTI", "desc": "16型人格测试，2种模式可选（短16题/完整93题）"},
...
- MBTI `tools/list` 返回 `mbti_start`、`mbti_answer`、`mbti_get_result`。
